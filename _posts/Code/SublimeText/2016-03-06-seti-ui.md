...
This is what Seti UI looks like on my machine: the sidebar chock full of folders and files, and clearly delineated text inputs with clearly visible text, even when it's selected. Word.
