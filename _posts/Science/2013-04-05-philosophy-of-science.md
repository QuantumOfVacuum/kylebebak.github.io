...
1. there is a causal relationship between events – any event must have cause(s)
2. the laws that determine these **cause/effect** relationships are **universal and immutable** - they apply everywhere and for all time
...
### Karl Popper
Skipping ahead 200 years we get to [Karl Popper](https://en.wikipedia.org/wiki/Karl_Popper), who was known for trying to demarcate the problem domain of science. He wanted to answer this question: **What assertions can be evaluated by science?**
...
### Occam’s Razor
Although it came long before, I see [Occam’s Razor](https://en.wikipedia.org/wiki/Occam%27s_razor), aka the principle of **parsimony/succinctness**, as a sort of footnote to Popper’s criteria.
